  ...
  return (
    <div className="bg">
      <div className='mainpage'>
        ...
        <p onClick={scrollToQ1} className='quizBtn'>Start &nbsp; Quiz</p>
        <button onClick={scrollToQ1} className="intro">	&or;</button>
      </div>

      <form className="quiz-container" onSubmit={handleSubmit}>
        <h2 ref={q1Ref} className="quiz-header2">Customize Your Vibe</h2>
        ...
        {/* Question 3: Genre */}
        <div ref={q3Ref} className="question-block, card2">
          <p>3. What kind of genre?</p>
          <select className="genre" name="genreKey" onChange={handleAnswerQ3} value={answers.genreKey}>
        ...
        {/* Question 4: Alcohol */}
        <div ref={q4Ref} className="question-block, card2">
        ...
        {/* Question 5: Flavor */}
        <div ref={q5Ref} className="question-block, card2">
